...
ALTER TABLE `Borrow_in_Sheet`
    ADD FOREIGN KEY (`employeeId`) REFERENCES `Employee` (`id`);

ALTER TABLE `Borrow_in_Sheet`
    ADD FOREIGN KEY (`readerId`) REFERENCES `Reader` (`id`);

ALTER TABLE `BorrowDetails`
    ADD FOREIGN KEY (`borrowId`) REFERENCES `Borrow_in_Sheet` (`id`);
...
ALTER TABLE `PenaltyDetails`
    ADD FOREIGN KEY (`penaltyId`) REFERENCES `Penalty` (`penaltyId`);
