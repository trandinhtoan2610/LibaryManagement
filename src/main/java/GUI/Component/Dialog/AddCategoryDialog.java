...
public class AddCategoryDialog extends JDialog {
    ...
    private JPanel setTitle() {
        ...
        JLabel txt = new JLabel("Thêm Danh Mục");
    ...
    private void addCategory() {
        try {
            ...
            Long newCategoryId = categoryBUS.addCategory(category);
            AlertDialog successDialog = new AlertDialog(this, "Thêm danh mục thành công với ID: " + newCategoryId);
            ...
            AlertDialog errorDialog = new AlertDialog(this, "Lỗi khi thêm danh mục: " + e.getMessage());
            errorDialog.setVisible(true);
        }
    }
}