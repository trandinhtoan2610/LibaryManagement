...
public class PenaltyReaderTable extends JTableCustom  {
    ...
    private List<PenaltyPreciousData<String>> readerList;
    ...
    public void setList(List<PenaltyPreciousData<String>> list){
    ...
    public void renderPenaltySheetTable(){
        ...
        for(PenaltyPreciousData<String> data : readerList){
