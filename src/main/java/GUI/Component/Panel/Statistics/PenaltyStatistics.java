...
public class PenaltyStatistics extends javax.swing.JPanel {
    ...
    private Map<String, List<PenaltyPreciousData<Long>> > employeeStats;
    private Map<String, List<PenaltyPreciousData<String>> > readerStats;
    ...
    private PenaltyFeeMonthBarChart monthBarChart;
    private PenaltyFeeYearBarChart yearBarChart;
    ...
    public void renderPreciousPanel(){
        ...
        List<PenaltyPreciousData<Long>> employeeList = employeeStats.get(year);
        List<PenaltyPreciousData<String>> readerList = readerStats.get(year);
    ...
    public void loadPreciousData(){
        for(String year : years){
            String key = year;
            List<PenaltyPreciousData<Long>> employeeList = penaltyBUS.getPreciousPenaltyEmployee(year);
            List<PenaltyPreciousData<String>> readerList = penaltyBUS.getPreciousPenaltyReader(year);
    ...
    public void showMonthBarChart(String year){
        ...
        monthBarChart = new PenaltyFeeMonthBarChart(monthStats.get(year));
    ...
    public void showYearBarChart(){
        ...
        yearBarChart = new PenaltyFeeYearBarChart(yearsDataList);
    ...
    private void cboxChooseYearItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cboxChooseYearItemStateChanged
        ...
        String year = cboxChooseYear.getSelectedItem().toString();
        List<PenaltyPreciousData<Long>> employeeListInYear = employeeStats.get(year);
        List<PenaltyPreciousData<String>> readerListInYear = readerStats.get(year);
